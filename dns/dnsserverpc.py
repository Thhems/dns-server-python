...
def fillzone(domain, restricted):
	var = {'portail.captif.dns.server.com.': {
	'$origin': 'portail.captif.dns.server.com.', 
	'$ttl': 3600, 
	'soa': {'mname': 'portail.captif.dns.server.com.', 'rname': 'admin.portail.captif.dns.server.com.', 'serial': '1', 'refresh': 3600, 'retry': 600, 'expire': 604800, 'minimum': 86400}, 
	'ns': [{'host': 'portail.captif.dns.server.com.'}], 
...
def getzone(domain, restricted):
	...
	if restricted == 1:
		zone_name = "portail.captif.dns.server.com."
	else:
		zone_name = "test.com."
	...
	if timedout == 0:
		...
		if addr[0]!= ip :
			...
			if addr[0] in good:
				...
				if final != "portail.captif.dns.server.com":
					if zonedata != 0:
						if i != height:
